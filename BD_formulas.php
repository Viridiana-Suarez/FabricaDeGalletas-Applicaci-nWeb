    ...
    <body>
        ...
        <?php
            ...
            function formulario($formula_nom){
                global $ingr_nom, $ingr_cant, $formula_nom,$connexion, $existencia;
                ...
                echo'
                    ...
                    <form name="f_formulas" method="get">
                        ...
                        <input id="op" name="tipo" type="text" size="35" style="display:none;" class="campo ingrePHP" value="'; echo $existencia,'">
                        ...
                        <input type="submit" value="¡Hecho!" name="terminado" class="button buttonPHP" onclick="aviso()">
                            <script>
                                function aviso(){
                                    var msg = document.getElementById("op").value; 
                                    alert(msg);
                                } 
                            </script>
                    </form>';
